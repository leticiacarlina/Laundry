...
class App_model extends CI_Model
{
	...
	public function MProsesTambahMember($nm_member, $tlp_member, $alamat_member)
	{
	...
	public function MHapusMember($id_member)
	{
		$this->db->where('id_member', $id_member);
		return $hasil = $this->db->delete('tb_member');
	}

	public function MEditMember($id_member)
	{
		$this->db->where('id_member', $id_member);
		return $hasil = $this->db->get('tb_member')->row_array();
	}

	public function MProsesEditMember($nm_member, $tlp_member, $alamat_member, $id_member)
	{
		$this->db->where('id_member', $id_member);
